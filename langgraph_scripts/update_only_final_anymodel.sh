...
export MODEL_ALIAS="kimik2_update_only_final"

export PORT=8080

export OUTPUT_DIR="/data/CHARM-MIMIC/kumars33/LLM_pratice/Textual_tabular_alignment-main/multimodal_simple/outputs/kimik2_update_only_final/"
