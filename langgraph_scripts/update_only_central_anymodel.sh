...
module load gcc CUDA/12.8.1 cmake
...
export LLAMA_SERVER="/data/CHARM-MIMIC/kumars33/LLM_pratice/Textual_tabular_alignment-main/llama.cpp/build2603/bin/llama-server"
...
#export MODEL_PATH="/data/CHARM-MIMIC/.cache/huggingface/gguf/Qwen3.5-397B-A17B-UD-IQ2_M-00001-of-00004.gguf"
#export MODEL_PATH="/data/CHARM-MIMIC/.cache/huggingface/gguf/gpt-oss-120b-F16.gguf"
#export MODEL_PATH="/data/CHARM-MIMIC/.cache/huggingface/gguf/Mistral-Small-4-119B-2603-UD-Q6_K-00001-of-00003.gguf"
#export MODEL_PATH="/data/CHARM-MIMIC/.cache/huggingface/gguf/GLM-5-UD-IQ1_M-00001-of-00006.gguf"
export MODEL_PATH="/data/CHARM-MIMIC/.cache/huggingface/gguf/Kimi-K2-Instruct-UD-TQ1_0-00001-of-00005.gguf"
#export MODEL_PATH="/data/CHARM-MIMIC/.cache/huggingface/gguf/DeepSeek-V3.2-UD-IQ2_M-00001-of-00005.gguf"
#export MODEL_PATH="/data/CHARM-MIMIC/.cache/huggingface/gguf/DeepSeek-R1-0528-UD-IQ1_S-00001-of-00004.gguf"

export MODEL_ALIAS="kimik2_update_only_central"

export PORT=8080

export OUTPUT_DIR="/data/CHARM-MIMIC/kumars33/LLM_pratice/Textual_tabular_alignment-main/multimodal_simple/outputs/kimik2_update_only_central/"
...
if [ $? -eq 0 ]; then
    ...
    for fname in "${summary_files[@]}"; do
        ...
        python /data/CHARM-MIMIC/kumars33/LLM_pratice/Textual_tabular_alignment-main/multimodal_simple/langgraph_runner_multimodal_v3_ablations.py \
            --summary_file "$fname" \
            --hadm_id $hadm_id \
