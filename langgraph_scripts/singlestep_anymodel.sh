#!/bin/bash
#SBATCH --job-name=dsv32_singlestep
...
export MODEL_ALIAS="dsv32_singlestep"

export PORT=8084

export OUTPUT_DIR="/data/CHARM-MIMIC/kumars33/LLM_pratice/Textual_tabular_alignment-main/multimodal_simple/outputs/dsv32_singlestep/"
...
if [ $? -eq 0 ]; then
    ...
    for fname in "${summary_files[@]}"; do
        ...
        python /data/CHARM-MIMIC/kumars33/LLM_pratice/Textual_tabular_alignment-main/multimodal_simple/langgraph_runner_singlestep_ablation.py \
            --summary_file "$fname" \
            --hadm_id $hadm_id \
